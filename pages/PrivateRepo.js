...
import { SoloTheme } from "../styles/Theme.js";
...
import MenuBar from "../subComponents/MenuBar.js";
import { device } from "../subComponents/device.js";
...
<GoBack>
<PowerButton/>
<motion.span initial={{scale:0}} animate={{scale:1}} transition={{delay:1.4, duration:1}}>This is a private organization repository, cannot visit. Click below to go back home</motion.span>
</GoBack>
<MenuBox>
