 ...
 transition: {
  ...
  return <motion.div exit={{opacity:0}}>
     ...
     { text1.split("").map((letter, id) => { if (letter === 'F')
            return (<motion.span key={id}> 
            <motion.span  key={id}> &nbsp;{letter}</motion.span>
            </motion.span>)
     else if(letter === 'S') return (<motion.span key={id}> 
     <motion.span key={id}> &nbsp;{letter}</motion.span>
     </motion.span>)
     
     else if(letter === 'k') return (<motion.span key={id}> 
     <motion.span key={id}> {letter}&nbsp;</motion.span>
     </motion.span>)
...
{ text4.split("").map((letter, id) => (
 (letter === 'S') ?  <motion.span variants={item} key={id}>  <motion.span  key={id} variants={spanVariants} initial="visible" whileHover="hover"> &nbsp;{letter}</motion.span></motion.span>
 :<motion.span variants={item} key={id}> 
 <motion.span  key={id} variants={spanVariants} initial="visible" whileHover="hover">{letter}</motion.span>
 </motion.span>
))}
