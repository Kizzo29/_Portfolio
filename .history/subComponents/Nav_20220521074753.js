...
const Nav = () => {
  ...
  return (
   ...
   {activeTabs === '/WorkPage' ? <a  href='/WorkPage' className={`${Styles.active}`} onClick={() => setActiveTabs('/WorkPage')}><Work width={12} height={12} fill={SoloTheme.text}/> </a> : <a  href='/WorkPage' onClick={() => setActiveTabs('/WorkPage')}><Work width={12} height={12} fill={SoloTheme.text}/> </a></Link>}
