...
const Nav = (props) => {
  ...
  return (
   ...
   {activeTabs === 'about' ? <Link href='/AboutPage' passHref><a className={`${Styles.active}`} onClick={() => setActiveTabs('/')}><About width={12} height={12} fill={SoloTheme.text}/></a></Link> : <Link href='/AboutPage'><a onClick={() => setActiveTabs('/AboutPage')}><About width={12} height={12} fill={SoloTheme.text}/> </a></Link>}    
