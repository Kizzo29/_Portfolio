...
const Nav = (props) => {
  ...
  return (
   ...
   {activeTabs === 'main' ? <Link href='/MainPage' passHref><a className={`${Styles.active}`}  onClick={() => setActiveTabs('main')}><PowerBtn width={12} height={12} fill={SoloTheme.text}/> </a></Link> : <Link href='/MainPage'><a onClick={() => setActiveTabs('/MainPage')}><PowerBtn width={12} height={12} fill={SoloTheme.text}/> </a></Link>}
   ...
   {activeTabs === 'about' ? <Link href='/AboutPage' passHref><a className={`${Styles.active}`} onClick={() => setActiveTabs('/AboutPage')}><About width={12} height={12} fill={SoloTheme.text}/></a></Link> : <Link href='/AboutPage'><a onClick={() => setActiveTabs('/AboutPage')}><About width={12} height={12} fill={SoloTheme.text}/> </a></Link>}    
